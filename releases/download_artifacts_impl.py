...
DEFAULT_REPO = "waveshareteam/ESP32-S3-Touch-AMOLED-1.75"
...
def latest_successful_run(
    repo: str, workflow: str, branch: str | None, event: str | None, token: str | None
) -> dict:
...
def main() -> int:
    ...
    parser.add_argument(
        "--run-id", type=int, help="GitHub Actions run id. If omitted, the latest successful run is used."
    )
