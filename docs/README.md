...
This index separates end-user guides from maintainer references and links each translated pair.

本索引区分用户指南与维护者参考，并为每组文档提供中英文入口。

## User Guides / 用户指南

| Topic / 主题 | English | 简体中文 |
| --- | --- | --- |
| First setup, release flashing, and source builds / 初次配置、发布固件烧录与源码构建 | [Getting Started](getting-started.md) | [快速开始](getting-started_ZH.md) |
| GPIO, buses, addresses, and expansion / GPIO、总线、地址与扩展接口 | [Hardware Reference](../HARDWARE_REFERENCE.md) | [硬件参考](../HARDWARE_REFERENCE_ZH.md) |
...
[English documentation](https://docs.waveshare.com/ESP32-S3-Touch-AMOLED-1.75) or
[Chinese documentation](https://docs.waveshare.net/ESP32-S3-Touch-AMOLED-1.75/).

产品配置、硬件资源、FAQ 与技术支持请查阅官方
[英文文档](https://docs.waveshare.com/ESP32-S3-Touch-AMOLED-1.75)或
[中文文档](https://docs.waveshare.net/ESP32-S3-Touch-AMOLED-1.75/)。
